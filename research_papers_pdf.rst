...
6.7. Check that corresponding author email address (or email addresses if there are a few of corresponding authors) are listed after "email:”. Multiple emails should be separated by a comma (,). Each corresponding author’s email (or group of emails) should be separated by a semicolon (;).
